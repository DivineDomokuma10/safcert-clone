      ...
      <nav className="w-screen bg-white flex items-center p-5 justify-between shadow-sm fixed top-0 left-0 z-50">
        ...
        {showDropMenu === false ? (
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-7 h-7 cursor-pointer font-bold hover:text-amber-500 md:hidden"
          ...
          <svg
            ...
            stroke="currentColor"
            onClick={() => toggleDropMenu()}
            className="w-7 h-7 cursor-pointer text-3xl font-extrabold hover:text-amber-500 md:hidden"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        {/* links */}
        <div className="w-1/5 h-1/2 hidden md:flex md:items-center md:justify-between">
          <a
            href="#home"
            className="px-2 py-1 text-gray-400 rounded-[5px] hover:text-black hover:border"
          >
            Home
          </a>
          <a
      ...
      {showDropMenu && (
        ...
        >
          <div className="w-full flex flex-col">
            <a
              href="#home"
              className="p-2 text-gray-400 rounded-[5px] hover:text-black hover:border"
            >
              Home
            </a>
            <a
              href="#feature"
              className="p-2 py-1 text-gray-400 rounded-[5px] hover:text-black hover:border"
            >
              Feature
            </a>
            <a
